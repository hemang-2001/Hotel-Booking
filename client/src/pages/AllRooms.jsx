...
const AllRooms = () => {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24' >
               ...
               <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-300 last:border-0' >
                    <img onClick={() => {navigate(`/room/${room._id}`); scrollTo(0,0)}}
                     ...
                     <div className='md:w-1/2 flex flex-col gap-2' >
                        ...
                        <p onClick={() => { navigate(`/room/${room._id}`); scrollTo(0,0)}} className='text-grey-800 text-3xl font-playfair cursor-pointer'>{room.hotel.name}</p>
                        ...
                        <div className='flex items-center gap-1 text-gray-500 mt-2 text-sm'>
                          ...
                          <span>{room.hotel.address}</span>
                            ...
                            <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'  > {/* Room Amenities  */}
            ...
            <div className='nh-white w-80 border border-gray-300 text-grey-600 max-lg:mb-8 min-lg:mt-16' > {/* right filters */}
