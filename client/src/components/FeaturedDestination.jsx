...
const FeaturedDestination = () => {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
        ...
        className='mt-16 px-4 py-2 text-sm font-medium border border-grey-300 rounded bg-white hover:bg-grey-50 transition-all cursor-pointer' >View All Destinations</button>
    </div>
  )
}
