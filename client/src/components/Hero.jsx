...
const Hero = () => {
  return (
        ...
        <p className='bg-[#CE2C59]/50 px-3.5 py-1 rounded-full mt-20'>The Ultimate Hotel Booking Experience</p>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base' >Unparalleled luxury and comfort await at the World's most exclusive Hotels and Resorts. Start your journey today.</p>
         <form className='bg-black/50 text-black-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <button className='flex items-center justify-center gap-1 rounded-md bg-[#CE2C59]/50 py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
